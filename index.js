...
const getPost = (post, users) => {
  ...
  newPost.classList =
    `container px-4 py-4 bg-white rounded-md border-2 border-black justify-self-center w-[90%] md:w-full card `;
  ...
  name.classList = 'text-black text-left block mt-2 flex flex-col';
